...
<section class="section-row">
    <div class="wrap">
        ...
        <div class="row feature__section">
            <div class="col-md-4">
                <div class="feature__img">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/staples/allsteel.jpg" alt="Global">
                </div>
                <h3 class="feature__title">
                    Vendor Spotlight
                </h3>
            ...
            <div class="col-md-4">
                <div class="feature__img">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/staples/plan.jpg" alt="Joe Fresh">
                </div>
                <h3 class="feature__title">
                Testimonial
                </h3>
                <p class="feature__desc">
                “Staples Business Advantage exceeded our expectations... We didn't just build an office, we created a home.  And I think if you look around you really see that.”</p>
                <p><strong>Melissa Kennedy, Executive Assistant/Facilities Manager, Plan Canada</strong></p>
                <a href="#" class="feature__learn-more">
                    Learn More
                </a>
            </div>
            <div class="col-md-4">
                <div class="feature__img">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/staples/table.jpg" alt="Staples Office Chair">
                </div>
                <h3 class="feature__title">
                    Featured Product
                </h3>
