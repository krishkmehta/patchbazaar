        ...
        <div class="row feature__section">
            <div class="col-md-4">
                <div class="feature__img">
                    <img src="<?php echo get_template_directory_uri() ?>/images/assets/staples/global.jpg" alt="Global">
                </div>
            ...
            <div class="col-md-4">
                <div class="feature__img">
                    <img src="<?php echo get_template_directory_uri() ?>/images/assets/staples/joe-fresh.jpg" alt="Joe Fresh">
                </div>
                <h3 class="feature__title">
                    Vendor Spotlight
                </h3>
            ...
            <div class="col-md-4">
                <div class="feature__img">
                    <img src="<?php echo get_template_directory_uri() ?>/images/assets/staples/office-chair.jpg" alt="Staples Office Chair">
                </div>
                <h3 class="feature__title">
                    Vendor Spotlight
                </h3>
