...
<section class="section-row image-content">
    <div class="wrap">
        <div class="col-md-6">
...
<section class="section-row feature-section-2 filled-section">
    <div class="wrap">
        ...
        <p class="sub-heading">
            Explore our solutions for your spaces.
        </p>
...
<section class="section-row our-process">
    <div class="wrap">
        <h2 class="section-title">Our Process</h2>
        <p class="sub-heading">
           Learn how we get you from start to finish.
        </p>
        <div class="row feature__section">
            <div class="col-md-3">
                <div class="feature__img">
                ...
                <p class="feature__desc">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur possimus, deserunt recusandae et amet sit fugit soluta aspernatur modi sint alias optio nostrum ullam error neque cupiditate eveniet aperiam.
                </p>
            </div>
            <div class="col-md-3">
                <div class="feature__img">
...
<section class="section-row dark-section">
    <div class="wrap">
        <h2 class="section-title">Solution</h2>
        <p class="sub-heading">
            Explore our solution for your spaces
        </p>
        <div class="row feature__section">
            <div class="col-md-4">
                <div class="feature__img">
                ...
                <p class="feature__desc">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est minima neque ut quos culpa nulla. Molestiae quas accusamus temporibus tempora voluptate, ullam deleniti. Obcaecati nam, dolore veniam rem animi voluptatum?
                </p>
...
<section class="section-row feature-section-2 filled-section">
    <div class="wrap">
        ...
        <p class="sub-heading">
            Brands we carry. Partners we trust.
        </p>
        <ul class="inline-list circle-list">
            <li>
                <a href="#" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_template_directory_uri()?>/assets/images/staples/global.jpg" alt="">
                </a>
            </li>
            <li>
                <a href="#" target="_blank" rel="noopener noreferrer">
            ...
            <li>
                <a href="#" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_template_directory_uri()?>/assets/images/staples/allsteel.jpg" alt="">
                </a>
            </li>
        </ul>
    </div>
