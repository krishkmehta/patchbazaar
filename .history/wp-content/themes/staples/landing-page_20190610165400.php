...
<picture>
	<source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/staples/header-img-1.jpg" media="(max-width: 991px)" 
	srcset="<?php echo get_template_directory_uri(); ?>/assets/images/staples/slider-img-mobile.jpg" media="(max-width: 767px)">
